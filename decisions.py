...
# The shortnand version may be used when there is only 
...
#Rewrite the match-case decision structure above as an if-elif-else
#decision structure.
grade = 'A'
...
print(result)
# Same output without creating a variable

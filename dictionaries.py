...
#function. Values in a dictionary can be of any data type and may be repeated.
...
#The Python len funtion tells the number of elements in a dictionary
print(len(nums))

#This line of code is creating a dictionary of mixed values
mixed_values = {1: 1, 2: 'two', 3: 3, 4: 'four', 5:'five'}
print(mixed_values)

#This line of code is creating a dictionary of mixed keys
...
#These lines of code is using a for loop to print out the values in a dictionary
